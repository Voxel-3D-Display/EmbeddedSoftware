...
module sdram_mm_interconnect_0 (
	...
	wire  [102:0] jtag_uart_0_avalon_jtag_slave_agent_rf_source_data;                                 // jtag_uart_0_avalon_jtag_slave_agent:rf_source_data -> jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo_out_data;                              // jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_uart_0_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [102:0] new_sdram_controller_0_s1_agent_rf_source_data;                                     // new_sdram_controller_0_s1_agent:rf_source_data -> new_sdram_controller_0_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] new_sdram_controller_0_s1_agent_rsp_fifo_out_data;                                  // new_sdram_controller_0_s1_agent_rsp_fifo:out_data -> new_sdram_controller_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> new_sdram_controller_0_s1_agent:cp_valid
	wire  [101:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> new_sdram_controller_0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // new_sdram_controller_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> new_sdram_controller_0_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> new_sdram_controller_0_s1_agent:cp_endofpacket
	...
	wire  [101:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [101:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire          new_sdram_controller_0_s1_agent_rdata_fifo_src_valid;                               // new_sdram_controller_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] new_sdram_controller_0_s1_agent_rdata_fifo_src_data;                                // new_sdram_controller_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          new_sdram_controller_0_s1_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_003:in_0_ready -> new_sdram_controller_0_s1_agent:rdata_fifo_src_ready
	...
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> new_sdram_controller_0_s1_agent:rdata_fifo_sink_data
	...
	sdram_mm_interconnect_0_router_001 router_001 (
	...
	sdram_mm_interconnect_0_router_002 router_002 (
	...
	sdram_mm_interconnect_0_router_003 router_004 (
	...
	sdram_mm_interconnect_0_router_003 router_005 (
	...
	sdram_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sdram_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
