...
# ACDS 21.1 842 win32 2022.03.01.18:25:13
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Pll_altpll_0.vo" -work altpll_0 -cdslib ./cds_libs/altpll_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Pll.v"                                                                        
fi
